...
//     * @return
//     */
//    public int lSetAll(String key, List<Object> values) {
//        try {
//            if (CollectionUtils.isEmpty(values)) {
//                return 0;
//            }
...
//     * @return
//     */
//    public int lLeftSetAll(String key, List<Object> values) {
//        try {
//            if (CollectionUtils.isEmpty(values)) {
//                return 0;
//            }
//            for (int i = 0; i < values.size(); i++) {
//                redisTemplate.opsForList().leftPushAll(key, JSON.toJSONString(values.get(i)));
//                expire(key, 24 * 3600);
//            }
//            return values.size();
//        } catch (Exception e) {
...
//     * @return
//     */
//    public int lSetAll(String key, List<Object> values, long time) {
//        try {
//            if (CollectionUtils.isEmpty(values)) {
//                return 0;
//            }
